    ...
    class MV_Testimonials_Post_Type{
        ...
        public function save_post(){
            ...
            if( isset( $_POST['action']) && $_POST['action'] == 'editpost' ){
                $old_occupation = get_post_meta( $post_id, 'mv_testimonials_occupations', true);
                $new_occupation = $_POST['mv_testimonials_occupations'];
                $old_company = get_post_meta( $post_id, 'mv_testimonials_company', true);
                $new_company = $_POST['mv_testimonials_ocompany'];
